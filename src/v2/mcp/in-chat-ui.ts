...
// MCP Apps hosts cache resource HTML by URI. Bump after adding the host bridge.
export const V2_IN_CHAT_RESOURCE_URI = "ui://studymeta/v2/learner-context-and-session-summary-v2";
...
const HOST_HANDSHAKE_SCRIPT = String.raw`<script>
  (() => {
    ...
    request("ui/initialize", {
      protocolVersion,
      appInfo: { name: "studymeta-v2-in-chat-ui", version: "0.2.0" },
